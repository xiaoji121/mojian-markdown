...
一个源码开放、面向阅读、学习和评注的 Markdown 编辑器：直接编辑、实时预览、双向定位、划线批注、保存长图、本地缓存与导入导出。可选接入本地 Agent Bridge，获得 AI 问答和最近阅读列表。
...
左侧保留 Markdown 原文，右侧呈现只读的阅读视图；最近阅读、文章大纲、批注和 AI 问答都围绕当前文档组织。
...
编辑左侧 Markdown 后，右侧预览实时更新。预览用于阅读、划线和批注；文字修改在原文编辑区完成。
